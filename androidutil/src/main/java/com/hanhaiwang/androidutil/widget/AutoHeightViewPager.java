...
/**
 * 使用tablayout+viewpager时，根据viewpager自适应fragment里面页面的高度，某一个fragment数据很多，页面很长，viewpager就很长，
 * 某一个fragment数据很少，页面很短，viewpager就很短，关键是viewpager，下面是自适应高度的viewpager代码
 */
